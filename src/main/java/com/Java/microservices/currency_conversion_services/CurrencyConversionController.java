...
public class CurrencyConversionController {
 private Logger logger = LoggerFactory.getLogger(CurrencyConversionController.class);
    ...
    //Method:-1 (lengthy procedure)(http://localhost:8100/currency-conversion/from/USD/to/INR/quantity/10)
    ...
    //Method:-2(using feign framework)(http://localhost:8100/currency-conversion-feign/from/USD/to/INR/quantity/10)
